...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            paddle_x = 375; //nadanie wartości początkowej zmiennej paddle_x, czyli nadanie współrzędnej x paletki
            paddle_y = 500; //nadanie wartości początkowej zmiennej paddle_x, czyli nadanie współrzędnej y paletki
        ...
        private void Form1_Paint(object sender, PaintEventArgs e) //Zdarzenie, które opisuje rysowanie w oknie
        {
        ...
        private void timer1_Tick(object sender, EventArgs e) //Obsługa zdarzeń licznika czasu
        {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e) //Obsługa zdarzeń wciśniętych klawiszy na klawiaturze
        {
        ...
        private void Form1_KeyUp(object sender, KeyEventArgs e) //Obsługa zdarzeń zwalnianych klawiszy na klawiaturze
        {
            if (e.KeyCode == Keys.Left)
            {
